...
This tech talk requires the use of both data.table and dplyr.  You should use the following to install them.  If you run into issues installing dplyr, it may be because dplyr requires a relatively new version of R.
